  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return Scaffold(
            floatingActionButton: userController.user.isCommunity
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    setState(
                                                                      ...
                                                                      if (postController
                                                                        ...
                                                                        postController
                                                                            .posts[i]
                                                                            .heart
                                                                            .remove(userController.user.username);
                                                                      } else {
                                                                        postController
                                                                            .posts[i]
                                                                            .isHeart = true;
                                                                        postController
                                                                            .posts[i]
                                                                            .heart
                                                                            .add(userController.user.username);
                                                                      }
                                                                    });
                                                                    ...
                                                                    try {
                                                                      final postDocumentSnapshot = await FirebaseFirestore
                                                                          ...
                                                                          .where(
                                                                              'caption',
                                                                              isEqualTo: postController.posts[i].caption)
                                                                          .where('usersName', isEqualTo: postController.posts[i].usersName)
                                                                          .where('postId', isEqualTo: postController.posts[i].postId)
                                                                          .get();
