...
import 'package:tarides/CommunityTabs/adminViewMembers/myMember.dart';
...
class ViewMyMembers extends StatefulWidget {
  const ViewMyMembers(
      {super.key,
  ...
  final String email;
  @override
  State<ViewMyMembers> createState() => _ViewMyMembersState();
}

class _ViewMyMembersState extends State<ViewMyMembers> {
                                        ...
                                        actions: <Widget>[
                                          ...
                                          Navigator.of(ctx).push(
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                       MyMembers(
                                                         email: userController.members[i].email,
                                                          username: userController.members[i].username,
                                                       ),
                                                  ),
                                                );
                                            },
