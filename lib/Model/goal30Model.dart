...
class Goal30 {
  Goal30({
    ...
    required this.goal30Category,
    required this.goal60Category,
    required this.goal90Category,
    required this.isGoal30,
    required this.day1,
    required this.day2,
    required this.day3,
    required this.day4,
  ...
  final bool userData;
  final bool goal30Category;
  final bool goal60Category;
  final bool goal90Category;
  late bool isGoal30;
  ...
  factory Goal30.fromDocument(DocumentSnapshot<Map<String, dynamic>> document) {
    ...
    return Goal30(
      ...
      goalLength: data['goalLength'] as int,
      userData: data['userData'] as bool,
      category: data['category'] as String,
      goal30Category: data['goal30Category'] as bool,
      goal60Category: data['goal60Category'] as bool,
      goal90Category: data['goal90Category'] as bool,
      isGoal30: data['isGoal30'] as bool,
