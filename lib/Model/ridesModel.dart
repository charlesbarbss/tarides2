...
class Rides {
  Rides({
    ...
    required this.isHostWinner,
    required this.isEnemyWinner,
  });
  ...
  final bool isHostWinner;
  final bool isEnemyWinner;
  ...
  factory Rides.fromDocument(DocumentSnapshot<Map<String, dynamic>> document) {
    ...
    return Rides(
      ...
      isHostWinner: data['isHostWinner'] as bool? ?? false,
      isEnemyWinner: data['isEnemyWinner'] as bool? ?? false,
    );
  }
}
